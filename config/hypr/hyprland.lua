...
hl.on("hyprland.start", function()
  ...
  hl.exec_once = swaync
  -- 1. Update D-Bus so apps can find the keyring under Wayland
  hl.exec_cmd("dbus-update-activation-environment --systemd WAYLAND_DISPLAY XDG_CURRENT_DESKTOP")

  os.execute("swww-daemon & sleep 0.5 && waypaper --restore &")
end)
...
-- Scroll through existing workspaces with mainMod + scrolling
